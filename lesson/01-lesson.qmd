...
- **The Basics**
	- [Visualization Basics](https://andrewheiss.shinyapps.io/ath-primers-basics-01-visualization/)
	- [Programming Basics](https://andrewheiss.shinyapps.io/ath-primers-basics-02-programming/)
- **Work with Data**
	- [Working with Tibbles](https://andrewheiss.shinyapps.io/ath-primers-transform-data-01-tibbles/)
	- [Isolating Data with dplyr](https://andrewheiss.shinyapps.io/ath-primers-transform-data-02-isolating/)
	- [Deriving Information with dplyr](https://andrewheiss.shinyapps.io/ath-primers-transform-data-03-deriving/)
