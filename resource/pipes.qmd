...
So I'm teaching you the native pipe, or `|>`. But don't panic if you see the magrittr pipe, or `%>%`, out there. And feel free to use it too. Again, 99% of the time, it works the same:
...
In RStudio, you can insert a pipe operator with a keyboard shortcut:^[The "M" here refers to the **m**agrittr pipe]

- On macOS: <kbd>⌘</kbd> + <kbd>⇧</kbd> + <kbd>M</kbd>
