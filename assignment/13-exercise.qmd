...
1. If you're using R on your own computer, download this file, [*unzip it*](/resource/unzipping.qmd), and double click on the file named `exercise-11.Rproj`: [{{< fa file-archive >}} `13-exercise.zip`](/projects/13-exercise.zip)
