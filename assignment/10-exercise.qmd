...
1. If you're using R on your own computer, download this file, [*unzip it*](/resource/unzipping.qmd), and double click on the file named `exercise-14.Rproj`: [{{< fa file-archive >}} `10-exercise.zip`](/projects/10-exercise.zip)
