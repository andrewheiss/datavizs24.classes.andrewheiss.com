...
The quickest and easiest way to get started is to install the {flexdashboard} package and then in RStudio go to File > New File… > Quarto Document… > From Template > Flexdashboard:
